...
<div class="author" style="margin-bottom:10px">
  {% if auth.avatar == "" %}
  <div style="display:inline-block;border-radius:7px;overflow:hidden;height:132px;width:100px;background-size:100px 132px;"><span class="icon fa-user styleN"></span></div>
  {% else %}
  <div style="display:inline-block;border-radius:7px;overflow:hidden;height:132px;width:100px;background:url({{ pic }});background-size:100px 132px;"></div>
  {% endif %}
